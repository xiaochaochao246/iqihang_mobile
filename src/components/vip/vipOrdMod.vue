<template>
  <div class="vip-index">
    <div class="address-addContent">
      <public-header :htitle="htitleTextTwo" :hurl="htitleUrl"></public-header>
...
export default {
  ...
  methods:{
    addedit(){//修改地址
      ...
      this.ruleForm.street = strs[3];
      this.addoder = this.$route.query.addoder;
    ...
    submitForm() {//地址提交
      if(this.ruleForm.name == ""){
        ...
        this.addres= this.AddressProvince +' ' + this. AddressCity +' ' +  this.Addresscounty+' ' + this.ruleForm.street;
        this.axios.post('/api/trade/order/v1/buy/edit/'+this.addoder, {
          orderCode:this.addoder,
          consignee:this.ruleForm.name,//收货人
          address:this.addres,//地址
          contactTel:this.ruleForm.phone,//电话
          device:'web',
        })
          .then(response => {
